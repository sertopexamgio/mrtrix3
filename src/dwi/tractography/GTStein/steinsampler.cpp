  ...
  namespace DWI
  {
    namespace Tractography
    {
      namespace GTStein
      {
        ...
        void SteinSampler::connect() // TODO Current implementation does not prevent loops.
        {
          //TRACE;
          stats.incN('c');
        ...
        Point_t SteinSampler::getRandPosInMask()
        {
          Point_t p;
          do
          {
        ...
        bool SteinSampler::inMask(const Point_t p)
        {
        ...
        Point_t SteinSampler::getRandDir()
        {
        ...
        void SteinSampler::moveRandom(const Particle *par, Point_t &pos, Point_t &dir)
        {
        ...
        bool SteinSampler::moveOptimal(const Particle *par, Point_t &pos, Point_t &dir) const
        {
          // assert(par != NULL);
